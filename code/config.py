DATASET_HYPERPARAMETERS = {
    ...
    'covid_deaths': {'freq': '1d', 'L': 14, 'fint': 'linear', 'fcomp': 'fcnn'},
}
...
ALL_DATASETS = ['australian_electricity_demand', 'nn5_daily_nomissing', 'weather', 'pedestrian_counts', 'kdd_cup_nomissing', 'covid_deaths']
